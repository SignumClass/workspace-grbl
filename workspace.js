...
cprequire_test(["inline:com-chilipeppr-workspace-grblcamv1"], function(ws) {
    ...
    $('title').html("grbl Workspace with CAM V1");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-grblcamv1", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-grblcamv1", // Make the id the same as the cpdefine id
        name: "Workspace / grbl with Cam V1", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace grbl with Cam V1.`,
              ...
              ["inline:com-chilipeppr-Widget-CamV1-Instance1"], // the id you gave your widget
                  function(myObjWidgetCam) {
                    ...
                    myObjWidgetCam.init();
                        ...
                        chilipeppr.load(
              "#com-chilipeppr-Widget-CamV1-Instance2",
              "http://raw.githubusercontent.com/xpix/widget-cam/master/auto-generated-widget.html",
              function() {
                // Callback after widget loaded into #myDivWidgetCam
                // Now use require.js to get reference to instantiated widget

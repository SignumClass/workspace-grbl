# com-chilipeppr-workspace-grblcamv1
A ChiliPeppr Workspace grbl with Cam V1.



## ChiliPeppr Workspace / grbl with Cam V1
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-grblcamv1 |
| Name                  | Workspace / grbl with Cam V1 |
| Description           | A ChiliPeppr Workspace grbl with Cam V1. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/SignumClass/workspace-grbl/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/signumclass/grblcamv1 |
| Github URL            | http://github.com/SignumClass/workspace-grbl |
| Test URL              | https://preview.c9users.io/signumclass/grblcamv1/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/SignumClass/workspace-grbl/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-grblcamv1"], // the id you gave your workspace
      function(myWorkspaceGrblcamv1) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / grbl with Cam V1 just got loaded.", myWorkspaceGrblcamv1);
        myWorkspaceGrblcamv1.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-grblcamv1"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / grbl with Cam V1"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace grbl with Cam V1."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/SignumClass/workspace-grbl/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/signumclass/grblcamv1"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/SignumClass/workspace-grbl"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://grblcamv1-signumclass.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
